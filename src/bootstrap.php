...
require_once PROJECT_ROOT . 'src/Resonder/HttpResponder.php';
require_once PROJECT_ROOT . 'src/Resonder/ShowLocationResponder.php';
require_once PROJECT_ROOT . 'src/Resonder/ShowHomepageResponder.php';
